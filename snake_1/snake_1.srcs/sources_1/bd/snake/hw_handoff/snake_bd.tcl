...
proc write_mig_file_snake_mig_7series_0_0 { str_mig_prj_filepath } {
   ...
   puts $mig_prj_file {    <ModuleName>snake_mig_7series_0_0</ModuleName>}
...
# End of write_mig_file_snake_mig_7series_0_0()
...
proc create_root_design { parentCell } {
  ...
  set tft_vga_b_0 [ create_bd_port -dir O -from 5 -to 0 tft_vga_b_0 ]
  set tft_vga_g_0 [ create_bd_port -dir O -from 5 -to 0 tft_vga_g_0 ]
  set tft_vga_r_0 [ create_bd_port -dir O -from 5 -to 0 tft_vga_r_0 ]
  ...
  write_mig_file_snake_mig_7series_0_0 $str_mig_file_path
  ...
  connect_bd_net -net axi_tft_0_ip2intc_irpt [get_bd_pins axi_tft_0/ip2intc_irpt] [get_bd_pins xlconcat_0/In3]
  connect_bd_net -net axi_tft_0_tft_hsync [get_bd_ports tft_hsync_0] [get_bd_pins axi_tft_0/tft_hsync]
  connect_bd_net -net axi_tft_0_tft_vga_b [get_bd_ports tft_vga_b_0] [get_bd_pins axi_tft_0/tft_vga_b]
  connect_bd_net -net axi_tft_0_tft_vga_g [get_bd_ports tft_vga_g_0] [get_bd_pins axi_tft_0/tft_vga_g]
  connect_bd_net -net axi_tft_0_tft_vga_r [get_bd_ports tft_vga_r_0] [get_bd_pins axi_tft_0/tft_vga_r]
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x44A00000 [get_bd_addr_spaces mdm_1/Data] [get_bd_addr_segs axi_tft_0/S_AXI_MM/Reg] SEG_axi_tft_0_Reg
  ...
  create_bd_addr_seg -range 0x08000000 -offset 0x80000000 [get_bd_addr_spaces mdm_1/Data] [get_bd_addr_segs mig_7series_0/memmap/memaddr] SEG_mig_7series_0_memaddr
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x40010000 [get_bd_addr_spaces axi_tft_0/Video_data] [get_bd_addr_segs axi_gpio_1/S_AXI/Reg] SEG_axi_gpio_1_Reg
  exclude_bd_addr_seg [get_bd_addr_segs axi_tft_0/Video_data/SEG_axi_gpio_1_Reg]

  create_bd_addr_seg -range 0x00010000 -offset 0x40020000 [get_bd_addr_spaces axi_tft_0/Video_data] [get_bd_addr_segs axi_gpio_2/S_AXI/Reg] SEG_axi_gpio_2_Reg
  exclude_bd_addr_seg [get_bd_addr_segs axi_tft_0/Video_data/SEG_axi_gpio_2_Reg]

  create_bd_addr_seg -range 0x00010000 -offset 0x41200000 [get_bd_addr_spaces axi_tft_0/Video_data] [get_bd_addr_segs axi_intc_0/S_AXI/Reg] SEG_axi_intc_0_Reg
  exclude_bd_addr_seg [get_bd_addr_segs axi_tft_0/Video_data/SEG_axi_intc_0_Reg]
