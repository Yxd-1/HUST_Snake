...
#
# Generated by export_simulation on Mon Jun 06 11:32:27 +0800 2022
#
################################################################################
...
'-reset_run' switch to the './snake.sh' script.
...
./snake.sh -noclean_files

For more information on the script, please type './snake.sh -help'.
